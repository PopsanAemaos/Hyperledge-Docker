...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
	...
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/mychaincode/javascript
elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/mychaincode/typescript
...
-----------------------------------------------------------------------------------------------------------------------
EOF
rm -rf ./operation/org1/wallet
rm -rf ./operation/org2/wallet
rm -rf ./operation/org3/wallet
cat<<EOF 
---------------------------------------------clean wallet Suscess----------------------------------------
EOF
